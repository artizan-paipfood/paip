...
class MaskUtils {
  ...
  static MaskInputController phonePtBr({required TextEditingController textEditingController, required int minLenght, bool isRequired = false}) {
    FocusNode? focusNode;
    final maskFormatter = [
    ...
    return MaskInputController(
      ...
      validator: (value) {
        ...
        if ((Utils.onlyNumbersRgx(value!).length > 1) && (Utils.onlyNumbersRgx(value).length < minLenght)) {
  ...
  static MaskInputController phone({
    ...
    final selectedCountry = Countries.countriesAllowOnboarding.firstWhereOrNull(
    ...
    return MaskInputController(
      ...
      onChanged: (value) {
        ...
        if (value.length == (selectedCountry?.maskMax?.length ?? 100)) {
  ...
  static MaskInputController cep({bool isRequired = false}) {
    FocusNode? focusNode;
    return MaskInputController(
      getFocusNode: () {
        focusNode = focusNode ?? FocusNode();
  ...
  static MaskInputController card() {
    FocusNode? focusNode;
  ...
  static MaskInputController cardDate() {
    FocusNode? focusNode;
    ...
    return MaskInputController(
      ...
      validator: (value) {
        ...
        if (!isValid(value!)) {
          isError = 'Invalid mounth';
        }

        if (isError == null) {
          final year = int.parse(value.split("/")[1]) + 2000;

          if (year < DateTime.now().year) {
            isError = 'Invalid year';
          }
        }
  ...
  static MaskInputController cardCvv() {
    FocusNode? focusNode;
  ...
  static MaskInputController cardholder() {
    FocusNode? focusNode;
