...
enum FlagsEnum {
  ...
  us(FlagModel.labelUk, FlagModel.pathUk, FlagModel.localeUk);
...
class FlagModel {
  ...
  //
  static const pathUk = "assets/flags/GB.png";
  static const labelUk = "English";
  static const localeUk = Locale("en");
}
