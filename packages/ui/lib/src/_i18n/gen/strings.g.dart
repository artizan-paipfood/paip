...
///
/// Built on 2025-08-08 at 17:50 UTC
...
enum AppLocale with BaseAppLocale<AppLocale, Translations> {
  ...
  Future<Translations> build({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver}) async {
    switch (this) {
      case AppLocale.enUs:
        return TranslationsEnUs(overrides: overrides, cardinalResolver: cardinalResolver, ordinalResolver: ordinalResolver);
      case AppLocale.ptBr:
...
class AppLocaleUtils extends BaseAppLocaleUtils<AppLocale, Translations> {
  AppLocaleUtils._() : super(baseLocale: AppLocale.enUs, locales: AppLocale.values);
