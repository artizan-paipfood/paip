...
class CategoryModel {
  ...
  List<ProductModel> get productsSortAZ => products.where((element) => element.visible).sorted((a, b) => a.name.compareTo(b.name));
  List<ProductModel> get productsSortIndexVisible => products.where((element) => element.visible).sorted((a, b) => a.index.compareTo(b.index));
  List<ProductModel> get productsSortIndex => products.sorted((a, b) => a.index.compareTo(b.index));
