...
//List<ItemModel> items;
  ...
  List<ItemModel> get itemsSortIndexVisible => items.where((element) => element.visible).toList().sorted((a, b) => a.index.compareTo(b.index));
  List<ItemModel> get itemsSortIndex => items.toList().sorted((a, b) => a.index.compareTo(b.index));
  List<ItemModel> get itemsSortAZ => items.where((element) => element.visible).toList().sorted((a, b) => a.name.compareTo(b.name));
