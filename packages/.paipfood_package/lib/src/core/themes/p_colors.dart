...
//*COLORS
  ...
  Color get white => isDark ? Colors.black : Colors.white;
  Color get black => isDark ? Colors.white : Colors.black;
  Color get border => isDark ? neutral400 : neutral200;
  Color get borderSecondary => isDark ? neutral400 : neutral400;
  Color get muted => secondaryText;
