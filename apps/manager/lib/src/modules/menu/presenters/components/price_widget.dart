...
class PriceWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (price == 0 && priceFrom == null) {
      return Text(context.i18n.gratuito, style: textStyle ?? context.textTheme.bodyLarge?.copyWith(color: colorText));
    }
    return Row(
      ...
      children: [
        ...
        Text((promotionalPrice ?? 0) > 0 ? promotionalPrice!.toStringCurrency : price.toStringCurrency, softWrap: true, overflow: TextOverflow.ellipsis, style: textStyle ?? context.textTheme.bodyLarge?.copyWith(color: colorText)),
      ],
    );
  }
}
