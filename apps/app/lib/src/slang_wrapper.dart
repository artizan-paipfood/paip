...
class SlangWrapperAppWidget extends StatelessWidget {
  const SlangWrapperAppWidget({super.key});

  @override
  Widget build(BuildContext context) {
    return //
        address.TranslationProvider(child: ui.TranslationProvider(child: i18n.TranslationProvider(child: auth.TranslationProvider(child: TranslationProvider(child: AppWidget())))));
  }
}
