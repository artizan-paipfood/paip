...
class SliverWrapSizesCartProduct extends StatefulWidget {
  final ProductModel product;
  final CartProductStore store;
  const SliverWrapSizesCartProduct({
  ...
  @override
  State<SliverWrapSizesCartProduct> createState() => _SliverWrapSizesCartProductState();
}

class _SliverWrapSizesCartProductState extends State<SliverWrapSizesCartProduct> {
