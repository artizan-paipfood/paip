...
class SliverDelegateSize extends SliverPersistentHeaderDelegate {
  ...
  SliverDelegateSize({required this.store, required this.context});
  @override
        ...
        child: Row(
          ...
          children: [
            ...
            DecoratedBox(
              ...
              child: Padding(padding: const EdgeInsets.symmetric(vertical: 6, horizontal: 8), child: Text(context.i18n.ok.toUpperCase(), style: context.textTheme.bodyMedium?.copyWith(color: context.color.neutral100, fontWeight: FontWeight.bold)).center),
            ),
          ],
        ),
      ),
