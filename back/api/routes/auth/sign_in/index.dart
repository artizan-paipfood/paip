...
Future<Response> _onPost(RequestContext context) async {
  ...
  final authenticator = injector.get<Authenticator>();
  ...
  final Map response = user.toMap()..addAll({'token': Authenticator.buildToken(id: id, password: password), 'refresh_token': Authenticator.buildRefreshToken(id: id, password: password)});
