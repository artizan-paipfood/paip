...
abstract class IWsService {
          ...
          (event) {
            if (event is String) {
              try {
                ...
                //   _onInitialize(hashcode: eventInitialize.hash, id: eventInitialize.id);
                ...
                // }
                log('Received event: $decode', name: 'ws_event');
                channel.sink.add('chegou $decode');
  ...
  void _onInitialize({required String hashcode, required String id}) {
