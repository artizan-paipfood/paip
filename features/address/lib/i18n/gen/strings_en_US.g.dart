...
extension on Translations {
  dynamic _flatMapFunction(String path) {
    switch (path) {
      case 'enderecos_de_entrega':
        return 'Delivery addresses';
      case 'endereco_e_numero':
        return 'Address and number';
      case 'usar_localizacao_atual':
        return 'Use current location';
      case 'editar':
        return 'Edit';
      case 'excluir':
        return 'Delete';
      case 'servicos_de_localizacao_desativados':
        return 'Location services disabled';
      case 'permissao_de_localizacao_negada':
        return 'Location permission denied';
      case 'permissao_de_localizacao_negada_permanentemente':
        return 'Location permission permanently denied';
      case 'rua':
        return 'Street';
      case 'numero':
        return 'Number';
      case 'endereco_sem_numero':
        return 'Address without number';
      case 'complemento':
        return 'Complement';
      case 'endereco_sem_complemento':
        return 'Address without complement';
      case 'bairro':
        return 'Neighborhood';
      case 'cep':
        return 'ZIP/ Postcode';
      case 'apelido':
        return 'Nickname';
      case 'apelido_placeholder':
        return 'Eg. Home, Work...';
      case 'casa':
        return 'Home';
      case 'trabalho':
        return 'Work';
      case 'complete_seu_endereco':
        return 'Complete your address';
      case 'salvar_endereco':
        return 'Save address';
      case 'confirmar_posicao':
        return 'Confirm position';
      case 'selecione_sua_posicao':
        return 'Select your position';
      case 'a_rua_nao_pode_ser_alterada':
        return 'The street cannot be changed';
      case 'a_rua_nao_pode_ser_alterada_descricao':
        return 'Try to adjust your position on the map.';
      case 'buscar_endereco_placeholder':
        return 'Address and number';
      case 'buscar_por_cep':
        return 'Search by ZIP/ Postcode';
      case 'buscar_endereco':
        return 'Search address';
      case 'insira_seu_endereco_no_campo_acima':
        return 'Enter your address above';
      case 'nenhum_endereco_encontrado':
        return 'No address found';
      case 'insira_o_cep_no_campo_acima':
        return 'Enter the ZIP/ Postcode above';
      case 'insira_seu_cep':
        return 'Enter your ZIP/ Postcode';
      default:
        return null;
    }
  }
