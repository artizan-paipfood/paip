...
class _MyAdressCardState extends State<MyAdressCard> {
  ...
  Widget build(BuildContext context) {
    return ArtTheme(
      data: ArtThemeData(
        colorScheme: ArtBlueColorScheme.dark(),
                  ...
                  Flexible(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(_address.complement, style: context.artTextTheme.muted.copyWith(fontSize: 12, color: context.artColorScheme.primary)),
                      ],
                    ),
                  ),
