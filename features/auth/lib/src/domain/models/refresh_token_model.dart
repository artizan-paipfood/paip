...
class RefreshTokenModel {
  ...
  factory RefreshTokenModel.fromToken({required String token, required String jwtSecret}) {
    final decode = JwtService.parseToken(token: token, secretKey: jwtSecret);
    //TODO: CRIAR CUSTOM EXCEPTION PARA REFRESH TOKEN
    return RefreshTokenModel.fromMap(decode);
  }
